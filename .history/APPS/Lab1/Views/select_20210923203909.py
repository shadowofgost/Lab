...
class IndexHandler(RequestHandler):
    ...
    def post(self):
        ...
        self.set_cookie("result_return",str(result_return))
...
class SelectHandler(RequestHandler):
    ...
    def post(self):
        ...
        prize_number_list = eval(self.get_cookie("prize_number_list"))
        prize_random_list = eval(self.get_cookie("prize_random_list"))
        result_return = eval(self.get_cookie("result_return"))
        ...
        self.set_cookie("award_list",str(result_return))
        self.render("select.html",award=result_return,print_results=print_results)
